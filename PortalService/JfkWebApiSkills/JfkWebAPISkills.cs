using MedicalNlpSkillsetFunctions.Cryptonym;
using MedicalNlpSkillsetFunctions.HocrGenerator;
using MedicalNlpSkillsetFunctions.ImagesStore;
using MedicalNlpSkillsetFunctions.Search;
...
namespace MedicalNlpSkillsetFunctions.WebApiSkill
{
    public static class WebApiSkills
    {
