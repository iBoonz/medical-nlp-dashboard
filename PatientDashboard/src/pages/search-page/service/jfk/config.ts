...
export const jfkServiceConfig: ServiceConfig = {
  ...
  initialState: {
    facetCollection: [
      {
        fieldId: "sign_symptom_concepts",
        displayName: "Sign Symptoms",
        iconName: null,
      ...
      {
        fieldId: "disease_disorder_concepts",
        displayName: "Disease Disorders",
        iconName: null,
        selectionControl: "checkboxList",
        values: null,
        config: {
      ...
      {
        fieldId: "anatomical_site_concepts",
        displayName: "Anatomical Sites",
        iconName: null,
        selectionControl: "checkboxList",
        values: null,
        config: {
      ...
      {
        fieldId: "medical_mention_concepts",
        displayName: "Medical Mentions",
        iconName: null,
        selectionControl: "checkboxList",
        values: null,
        config: {
