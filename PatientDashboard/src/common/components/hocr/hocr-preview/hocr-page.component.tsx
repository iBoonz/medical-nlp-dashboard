      ...
      <>
        ...
        >
          ...
          <image className={this.props.userStyle.image}
            x="0" y="0" width="100%" height="100%"
            xlinkHref={`${pageOptions.image}?st=2019-05-02T15%3A11%3A02Z&se=2032-05-03T15%3A11%3A00Z&sp=rl&sv=2018-03-28&sr=c&sig=YVlAKb3CDR9dphzSjPi1IcQ%2FZ%2Ffc9aoLXXQORZrh4eU%3D`} />           
